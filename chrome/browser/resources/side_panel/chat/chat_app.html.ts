...
import {ChatAppElement} from "./chat_app.js";
...
export function getHtml(this: ChatAppElement) {
    // return html`
    //     <webview src="http://localhost:3001/panel?url=example.com&title=Test&description=Sample"
    ...
    return html`
        <div id="main-container">
            <iframe
                    src=${"http://localhost:3001/panel?url=" + this.siteInfo_.url + "&title=" + this.siteInfo_.title + "&description=" + this.siteInfo_.description}
                    style="width:100vw; height:100vh; border:none; display:block; overflow:hidden;"
                    title="URL Parameter Extractor Panel">
