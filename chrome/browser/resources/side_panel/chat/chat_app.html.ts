...
import {ActionOnExtractedContent, ChatAppElement} from "./chat_app.js";
...
let sanitizedPolicy: any = null;

function getTrustedHTML(rawString: string) {
    if (sanitizedPolicy === null) {
        sanitizedPolicy = window.trustedTypes?.createPolicy("sanitize-inner-html", {
            createHTML: (s:string):string => s,
            createScript: (_:string, __:any[]):string => "",
            createScriptURL: (_:string, __:any[]):string => ""
        });
    }
                    ...
                    showThinkingText ? html`
                        <div class="thinking-text">
                            <div class="thinking-markdown-container"
                                 .innerHTML="${getTrustedHTML(marked.parse(thinkingText, {
                                     async: false,
                                     gfm: false
                                 }))}">
                            </div>
...
function getThinkingAndResponseElements(this: ChatAppElement,
    ...
    return html`
        <div class="thinking-and-response-container">
            ...
            ${getResponseElement.bind(this)(responseText, this.onResponseMarkdownContainerClick_)}
