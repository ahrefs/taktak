...
inline constexpr auto kInstallModes = std::to_array<InstallConstants>({
    // The primary (and only) install mode for Chromium.
    {
        ...
        .base_app_name = L"Taktak",              // A distinct base_app_name.
        .base_app_id = L"Taktak",                // A distinct base_app_id.
        .browser_prog_id_prefix = L"TaktakHTM",  // Browser ProgID prefix.
        .browser_prog_id_description =
            L"Taktak HTML Document",         // Browser ProgID description.
        .pdf_prog_id_prefix = L"TaktakPDF",  // PDF ProgID prefix.
        .pdf_prog_id_description =
            L"Taktak PDF Document",  // PDF ProgID description.
        .active_setup_guid =
